...
if (isset($_POST['submit'])) {
    ...
    if ( $usuarioEncontrado ) {
        ...
        $_SESSION['nombre_U'] = $usuarioEncontrado['nombre'];
        $_SESSION['area_U'] = $usuarioEncontrado['perfil'];
        $_SESSION['rutas_U'] = $usuarioEncontrado['rutas'];
        $_SESSION['foto_U'] = $usuarioEncontrado['foto'];
        $_SESSION['zona_U'] = false;
        $_SESSION['ruta_U'] = false;
