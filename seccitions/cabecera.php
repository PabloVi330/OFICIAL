        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="index.php" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="assets/images/logoMob.jpg" alt="" height="24">
                    </span>
                    <span class="logo-lg">
                        <img src="assets/images/logoMob.jpg" alt="" height="24"> <span class="logo-txt">Uruz</span>
                    </span>
                </a>
            ...
            <div class="dropdown d-inline-block bg-danger ">
                <button type="button" class="btn header-item
                    ...
                    <img class="rounded-circle header-profile-user"
                        src="controllers/uploads/users/<?php echo $_SESSION['foto_U'] ;?>" alt="Header Avatar">
