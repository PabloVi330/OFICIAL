...
class ControladorVentas
{
	...
	static public function ctrRangoFechasVentasJSON($fechaInicial, $fechaFinal)
	{
	...
	/*=============================================
	DESCARGAR EXCEL cantodad
	=============================================*/

	public function ctrDescargarReporteCantidad($data)
	{

		if (isset($data["lista-Productos"])) {
			...
			$Name = $data["lista-Productos"] . '.xls';
			$lista = json_decode($data["productos"]);
			$fecha = $data["fecha"];
			...
			echo utf8_decode("<table border='0'> 
					...
					<tr>
					 <td  style='font-weight:bold; border:1px solid #eee; text-aling:center'>
					  FECHA: ".$fecha."
					 </td>
					</tr>
					<tr> 
			...
			for ($i = 0; $i < count($lista); $i++) {
				...
				echo utf8_decode("<tr>
				<td style='border:1px solid #eee;'>" . $lista[$i]->id. "</td> ");

				echo utf8_decode("
					<td style='border:1px solid #eee;'> " .$lista[$i]->descripcion . "</td>
					<td style='border:1px solid #eee;'>" .$lista[$i]->cantidad . "</td>		
						</tr>");
			}
