			...
			<div class="col-lg-5 col-xs-12">
                ...
                ======================================-->
                        ...
                        <div class="col-xs-3">
                          ...
                          <input type="number" class="form-control nuevaCantidadProducto" name="nuevaCantidadProducto" step="any" min="0" value="' . $value["cantidad"] . '" stock="' . $stockAntiguo . '" nuevoStock="' . $value["stock"] . '" required>
