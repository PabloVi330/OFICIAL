...
class ModeloProformas{
	...
	static public function mdlEditarProformas($tabla, $datos){
	...
	static public function mdlEliminarProformas($tabla, $datos){
	...
	static public function mdlRangoFechasProformas($tabla, $fechaInicial, $fechaFinal){
	...
	static public function mdlSumaTotalProformas($tabla){	
